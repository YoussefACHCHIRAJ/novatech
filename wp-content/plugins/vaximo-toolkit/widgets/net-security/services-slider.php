...
namespace Elementor;
class Vaximo_ServicesSlider extends Widget_Base {

	public function get_name() {
        return 'VaximoServicesSlider';
    }

	public function get_title() {
        return __( 'NS Services Slider', 'vaximo-toolkit' );
    }
	...
	protected function render() {
        ...
        <div class="container">
            <div class="ns-services-slides owl-carousel owl-theme">
                <?php $loop = 1; 
...
Plugin::instance()->widgets_manager->register( new Vaximo_ServicesSlider );