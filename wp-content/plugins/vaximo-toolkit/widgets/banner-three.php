<?php
namespace Elementor;
class BannerThree extends Widget_Base{
    ...
    protected function render()
    {
        ...
        <section class="banner-area banner-area-three" style="background-image: url(<?php echo esc_url( $settings['image']['url']); ?> )">
			<div class="d-table">
...
Plugin::instance()->widgets_manager->register( new BannerThree );