<?php
namespace Elementor;
class BannerTwo extends Widget_Base{
    public function get_name(){
        return "banner-two-widget";
    }
    public function get_title(){
        return "Banner Two Area";
    }
        ...
        $this-> start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'    => Controls_Manager::TEXT,
                    'default' => __('A Team Of Professionals To Protect Your Team', 'vaximo-toolkit'),
                ]
            );
            $this->add_control(
                'head_tag',
					...
					<div class="container-fluid">
						<div class="row align-items-center">
                            ...
                            <?php if( !empty( $settings['image']['url'] ) ) { ?>
                                <div class="col-lg-6">
                                    <div class="banner-site-img <?php if ( 'yes' === $settings['is_animation'] ) { ?> wow fadeInDown <?php } ?>" data-wow-delay=".6s">
...
Plugin::instance()->widgets_manager->register( new BannerTwo );