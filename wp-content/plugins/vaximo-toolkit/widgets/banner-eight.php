<?php
namespace Elementor;
class BannerEight extends Widget_Base{
        ...
        $this-> start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .new-main-banner-wrap-content h1, .new-main-banner-wrap-content h2, .new-main-banner-wrap-content h3, .new-main-banner-wrap-content h4, .new-main-banner-wrap-content h5, .new-main-banner-wrap-content h6' => 'color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => ' {{WRAPPER}} .new-main-banner-wrap-content h1, .new-main-banner-wrap-content h2, .new-main-banner-wrap-content h3, .new-main-banner-wrap-content h4, .new-main-banner-wrap-content h5, .new-main-banner-wrap-content h6',
                ]
            );
            $this->add_control(
                'desc_color',
                [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .new-main-banner-wrap-content p,  .new-main-banner-wrap-content ul li, .new-main-banner-wrap-content ol li' => 'color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => ' {{WRAPPER}} .new-main-banner-wrap-content p,  .new-main-banner-wrap-content ul li, .new-main-banner-wrap-content ol li',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .new-main-banner-wrap-content .banner-btn li .default-btn' => 'color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_control(
            ...
            $this->add_group_control(
                ...
                [
                    'name'     => 'btn1bg_color',
                    'types'    => ['gradient' ],
                    'selector' => '{{WRAPPER}} .new-main-banner-wrap-content .banner-btn li .default-btn',
                ]
            );
            $this->add_control(
                'inner_div2',
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .new-main-banner-wrap-content .banner-btn li .default-btn:hover' => 'color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .new-main-banner-wrap-content .banner-btn li .default-btn::before, .new-main-banner-wrap-content .banner-btn li .default-btn::after' => 'background-color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_group_control(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .new-main-banner-wrap-content .banner-btn li .default-btn.color-two' => 'color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .new-main-banner-wrap-content .banner-btn li .default-btn.color-two' => 'border-color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .new-main-banner-wrap-content .banner-btn li .default-btn.color-two' => 'background: {{VALUE}}',
                    ],
                ]
            );
            $this->add_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .new-main-banner-wrap-content .banner-btn li .default-btn.color-two:hover' => 'color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .new-main-banner-wrap-content .banner-btn li .default-btn.color-two::before, .new-main-banner-wrap-content .banner-btn li .default-btn.color-two::after' => 'background-color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => ' {{WRAPPER}} .new-main-banner-wrap-content .banner-btn li .default-btn.color-two',
                ]
            );
    ...
    protected function render()
    {
        ...
        <section class="new-main-banner-area-wrap">
			<div class="new-main-banner-wrap-item" style="background-image: url(<?php echo esc_url( $settings['image']['url']); ?> )">
...
Plugin::instance()->widgets_manager->register( new BannerEight );