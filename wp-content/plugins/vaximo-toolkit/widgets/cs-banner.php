<?php
namespace Elementor;
class BannerCloudSecurity extends Widget_Base{
    public function get_name(){
        return "banner-cloud-security";
    }
    ...
    protected function register_controls(){
        ...
        $this-> start_controls_section(
            ...
            $this->add_control(
                'bg_video_url',
                [
                    'label' => __( 'Banner Video Url', 'vaximo-toolkit' ),
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'    => Controls_Manager:: TEXT,
                    'default' => __('Certified Security Experts', 'vaximo-toolkit'),
                ]
            );
            $this->add_control(
                'title',
                [
                    ...
                    'default' => __('Secure Your Cloud, Secure Your Business', 'vaximo-toolkit'),
                ]
            );
            $this->add_control(
                'head_tag',
            ...
            $this->add_control(
                ...
                [
                    'label'   => __( 'Content', 'vaximo-toolkit' ),
                    'type'    => Controls_Manager::TEXTAREA,
                    'default' => __('Comprehensive Cloud Security Solutions Designed to Protect Your Digital Assets in the Cloud', 'vaximo-toolkit'),
                ]
            );
            $this->add_control(
                'button_text',
                [
                    ...
                    'type'    => Controls_Manager::TEXT,
                    'default' => __('Get Started Now', 'vaximo-toolkit'),
                ]
            );
            $this->add_control(
                'link_type',
        ...
        $this-> start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .cloud-security-banner-content .sub' => 'color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_group_control(
                Group_Control_Typography::get_type(), [
                    ...
                    'selector' => ' {{WRAPPER}} .cloud-security-banner-content .sub',
                ]
            );
            $this->add_control(
                'title_color',
                [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .cloud-security-banner-content h1' => 'color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_group_control(
                Group_Control_Typography::get_type(), [
                    ...
                    'selector' => ' {{WRAPPER}} .cloud-security-banner-content h1',
                ]
            );
            $this->add_control(
                'desc_color',
                [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .cloud-security-banner-content p' => 'color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_group_control(
                Group_Control_Typography::get_type(), [
                    ...
                    'selector' => ' {{WRAPPER}} .cloud-security-banner-content p',
                ]
            );
            $this->add_control(
                'btn_onecolor', [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .cloud-security-banner-content .banner-btn li .default-btn' => 'color: {{VALUE}};',
                    ],
                ]
            );
            $this->add_control(
                'btn_onebgcolor', [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .cloud-security-banner-content .banner-btn li .default-btn' => 'background: {{VALUE}};',
                    ],
                ]
            );
            $this->add_control(
            ...
            $this->add_control(
                'btn_onehbgcolor', [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .cloud-security-banner-content .banner-btn li .default-btn::after' => 'background: {{VALUE}};',
                    ],
                ]
            );
            $this->add_group_control(
                Group_Control_Typography::get_type(), [
                    ...
                    'selector' => ' {{WRAPPER}} .cloud-security-banner-content .banner-btn li .default-btn',
                ]
            );
            $this->add_control(
                'btn_twocolor', [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .cloud-security-banner-content .banner-btn li .default-btn.color-two' => 'color: {{VALUE}};',
                    ],
                ]
            );
            $this->add_control(
                'btn_twobgcolor', [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .cloud-security-banner-content .banner-btn li .default-btn.color-two' => 'background-color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                'btn_2borcolor', [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .cloud-security-banner-content .banner-btn li .default-btn.color-two' => 'border-color: {{VALUE}};',
                    ],
                ]
            );
            $this->add_control(
                'btn_2hcolor', [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .cloud-security-banner-content .banner-btn li .default-btn.color-two:hover' => 'color: {{VALUE}};',
                    ],
                ]
            );
            $this->add_control(
                'btn_2hbgcolor', [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .cloud-security-banner-content .banner-btn li .default-btn.color-two:hover' => 'background-color: {{VALUE}};',
                    ],
                ]
            );
            $this->add_group_control(
                Group_Control_Typography::get_type(), [
                    ...
                    'selector' => ' {{WRAPPER}} .cloud-security-banner-content .banner-btn li .default-btn.color-two',
                ]
            );
        $this-> end_controls_section();
    ...
    protected function render()
    {
        ...
        <!-- Start Cloud Security Banner Area -->
		<div class="cloud-security-banner-area">
            <?php if ( $settings['bg_video_url'] != '' ) : ?>
                <video loop="" muted="" autoplay="" class="banner-video">
                    <source src="<?php echo wp_kses_post( $settings['bg_video_url'] ); ?>" type="video/mp4">
                </video>
            <?php endif; ?>
			<div class="container">
				<div class="cloud-security-banner-content">
                    <span class="sub"><?php echo esc_html( $settings['top_title'] ); ?></span>
                    <<?php echo esc_attr( $settings['head_tag'] ); ?> class="htitle"><?php echo esc_html( $settings['title'] ); ?></<?php echo esc_attr( $settings['head_tag'] ); ?>>
		...
		<!-- End Cloud Security Banner Area -->

        <?php
    }
}
Plugin::instance()->widgets_manager->register( new BannerCloudSecurity );